...
Module that defines a function to multiplies 2 matrices
...
def matrix_mul(m_a, m_b):
    ...
    Returns:
        A new list which is the result of m_a by m_b
    ...
    for i in range(len(m_b[0])):
        ...
        for j in range(len(m_b)):
            row_1.append(m_b[j][i])
        matrix1.append(row_1)
